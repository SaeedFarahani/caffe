...
execute_process(
  COMMAND "/usr/bin/git" show-ref aab753280e83137ba955f8f19d72cb6aaba545ef
...
if("${show_ref_output}" MATCHES "refs/remotes/aab753280e83137ba955f8f19d72cb6aaba545ef
")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "aab753280e83137ba955f8f19d72cb6aaba545ef
")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "aab753280e83137ba955f8f19d72cb6aaba545ef
")
endif()
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 aab753280e83137ba955f8f19d72cb6aaba545ef
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/01org/mkl-dnn.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/saeed/caffe/caffe-intel/external/mkldnn/src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/saeed/caffe/caffe-intel/external/mkldnn/src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
